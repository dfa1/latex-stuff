...
I metodi basati su Jacobi hanno attratto l'attenzione poichè hanno un altro grado di parallelismo e possono, sotto determinate condizioni, fornire valori più accurati del metodo QR. Discuteremo un metodo \cite{zhou} simile a quello di Jacobi  per la diagonalizzazione di matrici reali normali. Questo metodo usa sono operazioni nei reali e trasformazioni simili, risultando in una convergenza quadratica.
...
\begin{thebibliography}{5}
  ...
  \bibitem{zhou} Zhou, B. B. and Brent, R. P. 2003. An efficient method for computing eigenvalues of a real normal matrix. J. Parallel Distrib. Comput. 63, 6 (Jun. 2003), 638-648. DOI= http://dx.doi.org/10.1016/S0743-7315(03)00007-8
