...
Al fine di determinare la probabilità di assorbimento dello stato $1$ ora possiamo usare la seguente formula:
...
$$
P(T_{S \backslash T} < +\inf) = \sum_{j \in S}{\lambda_{j}\pi_0(j)}  
$$\label{1}

Applicando la \ref{1} si ottiene dunque
\end{document}
